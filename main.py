...
DATA_URL = os.getenv('QR_DATA_URL', 'https://github.com/Krishna-Sathvika-Ganni/IS601-HOMEWORK71.git')
QR_DIRECTORY = os.getenv('QR_CODE_DIR', 'qr_codes')  # Directory for saving QR code
QR_FILENAME = os.getenv('QR_CODE_FILENAME', 'MyQRCode.png')  # Filename for the QR code
